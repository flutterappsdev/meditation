...
class _EditProfileState extends State<EditProfile> {
  ...
  List<PurchaseDetails> transaction = [];
  Future<void> _getpastPurchases() async {
    ...
    if (response.pastPurchases.length > 0) {
      response.pastPurchases.forEach(
        (purchase) async {
          print('Achats antérieurs   ${purchase.productID}');
        },
      );

      setState(() {
        transaction = response.pastPurchases;

        transaction.forEach((t) {
          print(t.billingClientPurchase);
        });
      });
    } else {
      print('Aucun achat antérieur!');
    }
    setState(
      () {
        isLoading = false;
                                                            ...
                                                            children: <Widget>[
                                                                ...
                                                                children: <
                                                                  ...
                                                                  Text(DateFormat
                                                                      ...
                                                                      .format(DateTime.fromMillisecondsSinceEpoch(
                                                                              int.parse(item.transactionDate))
                                                                          .toLocal())
                                                                      .toString()),
                                                                ],
                                                              ),
                                                              Row(
                                                                ...
                                                                children: <
                                                                  ...
                                                                  Text(DateFormat
                                                                          .yMMMEd()
                                                                      .format(DateTime.fromMillisecondsSinceEpoch(int.parse(item
                                                                              .transactionDate))
                                                                          .add(extendDAte(
                                                                              item.productID))
                                                                          .toLocal())
                                                              ...
                                                              Row(
                                                                ...
                                                                children: <
                                                                  ...
                                                                  Text(
                                                                    !Platform
                                                                            .isIOS
                                                                        ? item.billingClientPurchase.isAutoRenewing
                                                                            ? 'Active'
                                                                            : ""
                                                                        : "Active",
                                                                    style: TextStyle(
